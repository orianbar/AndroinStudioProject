...
public class MainActivity extends AppCompatActivity  {
    ...
    Dialog myDialog3;
    Switch mySwitch2;
    String name1,name2,name3,score1,score2,score3,name4;
    ImageView myImage;
    ImageView myImage2;
    ImageView myImage3;
    ImageView settingsX;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindowManager().getDefaultDisplay().getSize(point);
         scoreOver=prefs.getInt("scoreOver",0);
        ...
        name4=prefs.getString("username",null);
...
private void initControls(){
    ...
    private void openDialog1() {
        ...
        if(scoreOver==Integer.parseInt(String.valueOf(score1))){
            oneName.setText(name4);
            collection.putString("name1",name4);
        }
        if(scoreOver==Integer.parseInt(String.valueOf(score2))){
            twoName.setText(name4);
            collection.putString("name2",name4);
        }
        if(scoreOver==Integer.parseInt(String.valueOf(score3))){
            threeName.setText(name4);
            collection.putString("name3",name4);
        }
        collection.apply();
