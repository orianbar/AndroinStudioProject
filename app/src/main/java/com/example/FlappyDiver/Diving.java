...
public class Diving {
    ...
    Diving(int screenY, Resources res){
        ...
        diving1= BitmapFactory.decodeResource(res,R.drawable.diving1,op);
        diving2= BitmapFactory.decodeResource(res,R.drawable.dving2,op);
        diving3= BitmapFactory.decodeResource(res,R.drawable.diving4,op);
